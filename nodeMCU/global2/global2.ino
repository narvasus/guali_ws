...
int angle1 = initial_servo1;
int angle2 = initial_servo2;
int angle3 = initial_servo3;
int angle4 = initial_servo4;
int angle5 = initial_servo5;
int angle6 = initial_servo6;
...
void processData()
{
  ...
  {
  case 'A':
    angle1 = atoi(receivedChars + 1);
    moveServos(angle1, angle2, angle3, angle4, angle5, angle6);
    Serial.print("ok");
    break;
  case 'B':
    angle2 = atoi(receivedChars + 1);
    moveServos(angle1, angle2, angle3, angle4, angle5, angle6);
    Serial.print("ok");
    break;
  case 'C':
    angle3 = atoi(receivedChars + 1);
    moveServos(angle1, angle2, angle3, angle4, angle5, angle6);
    Serial.print("ok");
    break;
  case 'D':
    angle4 = atoi(receivedChars + 1);
    moveServos(angle1, angle2, angle3, angle4, angle5, angle6);
    Serial.print("ok");
    break;
  case 'E':
    angle5 = atoi(receivedChars + 1);
    moveServos(angle1, angle2, angle3, angle4, angle5, angle6);
    Serial.print("ok");
    break;
  case 'F':
    angle6 = atoi(receivedChars + 1);
    moveServos(angle1, angle2, angle3, angle4, angle5, angle6);
    Serial.print("ok");
    break;
  default:;
...
void loop()
{
  ...
  // Rest of the code goes here if needed
}
